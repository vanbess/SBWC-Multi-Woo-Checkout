jQuery(document).ready( function( $ ) {
    ...
    $('.col_package_item').click(function() {
        ...
        $('.statistical td.td-price .price_before').html($(this).find('.w_content_price_before .price').html());
        $('.statistical td.td-price .price_now').html($(this).find('.w_content_price_now .price').html());
        $('.statistical td.td_total_price').html($(this).find('.w_content_price_total .price').html());
